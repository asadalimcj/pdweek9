...
// file handling
void readBulletCountFromfile();
void storeBulletCountInFile();
void readHealthFromFile();
void storeHealthInFile();
void storeSnowbroInFile();
void readSnowbroFromFile();
...
void readBulletCountFromfile()
{
    ...
    file.open("BulletCount.txt", ios::in);
    {
        ...
        file >> bulletCountTick;
        file >> bulletCountYom;
        file >> bulletCountLynch;
        file >> bulletCountGhost;
    }
    file.close();
}
void storeBulletCountInFile()
{
    ...
    file << bulletCountTick << endl;
    file << bulletCountYom << endl;
    file << bulletCountLynch << endl;
    file << bulletCountGhost << endl;
    file.close();
}
void readHealthFromFile()
{
...
void storeHealthInFile()
{
    ...
    file << tick_health << endl;
    file << yom_health << endl;
    file << lynch_health << endl;
    file << ghost_health << endl;
    file.close();
}
void storeSnowbroInFile()
{
    fstream file;
    file.open("SnowBro.txt", ios::out);
    file << snowbroX << endl;
    file << snowbroY << endl;
    file << enemyX << endl;
    file << enemyY << endl;
